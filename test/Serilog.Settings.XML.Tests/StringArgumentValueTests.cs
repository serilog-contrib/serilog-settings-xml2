...
namespace Serilog.Settings.XML.Tests
{
    public class StringArgumentValueTests
    {
        ...
        {
            var stringArgumentValue = new StringArgumentValue("Serilog.Settings.XML.Tests.Support.ConcreteClass, Serilog.Settings.XML.Tests");
        ...
        [Theory]
        [InlineData("Serilog.Settings.XML.Tests.Support.ClassWithStaticAccessors::InterfaceProperty, Serilog.Settings.XML.Tests", typeof(IAmAnInterface))]
        [InlineData("Serilog.Settings.XML.Tests.Support.ClassWithStaticAccessors::AbstractProperty, Serilog.Settings.XML.Tests", typeof(AnAbstractClass))]
        [InlineData("Serilog.Settings.XML.Tests.Support.ClassWithStaticAccessors::InterfaceField, Serilog.Settings.XML.Tests", typeof(IAmAnInterface))]
        [InlineData("Serilog.Settings.XML.Tests.Support.ClassWithStaticAccessors::AbstractField, Serilog.Settings.XML.Tests", typeof(AnAbstractClass))]
        ...
        [Theory]
        // unknown type
        [InlineData("Namespace.ThisIsNotAKnownType::InterfaceProperty, Serilog.Settings.XML.Tests", typeof(IAmAnInterface))]
        // good type name, but wrong namespace
        [InlineData("Random.Namespace.ClassWithStaticAccessors::InterfaceProperty, Serilog.Settings.XML.Tests", typeof(IAmAnInterface))]
        // good full type name, but missing or wrong assembly
        [InlineData("Serilog.Settings.XML.Tests.Support.ClassWithStaticAccessors::InterfaceProperty", typeof(IAmAnInterface))]
        ...
        [Theory]
        // unknown member
        [InlineData("Serilog.Settings.XML.Tests.Support.ClassWithStaticAccessors::UnknownMember, Serilog.Settings.XML.Tests", typeof(IAmAnInterface))]
        // static property exists but it's private
        [InlineData("Serilog.Settings.XML.Tests.Support.ClassWithStaticAccessors::PrivateInterfaceProperty, Serilog.Settings.XML.Tests", typeof(IAmAnInterface))]
        // static field exists but it's private
        [InlineData("Serilog.Settings.XML.Tests.Support.ClassWithStaticAccessors::PrivateInterfaceField, Serilog.Settings.XML.Tests", typeof(IAmAnInterface))]
        // public property exists but it's not static
        [InlineData("Serilog.Settings.XML.Tests.Support.ClassWithStaticAccessors::InstanceInterfaceProperty, Serilog.Settings.XML.Tests", typeof(IAmAnInterface))]
        // public field exists but it's not static
        [InlineData("Serilog.Settings.XML.Tests.Support.ClassWithStaticAccessors::InstanceInterfaceField, Serilog.Settings.XML.Tests", typeof(IAmAnInterface))]
        public void StaticAccessorWithInvalidMemberThrowsInvalidOperationException(string input, Type targetType)
        {
            ...
            Assert.Contains("on type `Serilog.Settings.XML.Tests.Support.ClassWithStaticAccessors, Serilog.Settings.XML.Tests`", exception.Message);
        }
        ...
        public void ReferencingUndeclaredLevelSwitchThrows()
        {
            ...
            //Assert.Contains("<LevelSwitches> <Switch Name=\"$mySwitch\"", ex.Message);
        }
